...
void SatFrameRtn::copy(const SatFrameRtn& other)
{
    ...
    this->channelRatio_var = other.channelRatio_var;
}
...
void SatFrameRtn::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->channelRatio_var);
}
...
void SatFrameRtn::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->channelRatio_var);
}
...
//设置信道系数
double SatFrameRtn::getChannelRatio() const
{
    return channelRatio_var;
}

void SatFrameRtn::setChannelRatio(double channelRatio)
{
    this->channelRatio_var = channelRatio;
}
...
int SatFrameRtnDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "channelRatio")==0) return base+3;
...
std::string SatFrameRtnDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return double2string(pp->getChannelRatio());
        default: return "";
    }
}
...
bool SatFrameRtnDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setChannelRatio(string2double(value)); return true;
